...
if ( TRACE ) { TRACE( "AudioLibrary.ClipEntry#$clone", this ); }
    ...
    /*BookInstantiate start.*/
    Bridge.define("BookInstantiate", {
        inherits: [UnityEngine.MonoBehaviour],
        fields: {
            bookInstantiate: null,
            offsetVector: null,
            originalPos: null
        },
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "BookInstantiate#init", this ); }

                this.offsetVector = new UnityEngine.Vector3();
            }
        },
        methods: {
            /*BookInstantiate.Start start.*/
            Start: function () {
if ( TRACE ) { TRACE( "BookInstantiate#Start", this ); }

                for (var i = 0; i < this.bookInstantiate.length; i = (i + 1) | 0) {
                    var instance = UnityEngine.Object.Instantiate(UnityEngine.GameObject, this.bookInstantiate[i], this.originalPos.transform);

                    instance.transform.localPosition = pc.Vec3.ZERO.clone().add( this.offsetVector.$clone().clone().scale( i ) );
                    instance.transform.localRotation = pc.Quat.IDENTITY.clone();
                    instance.transform.localScale = new pc.Vec3( 1, 1, 1 );
                }
            },
            /*BookInstantiate.Start end.*/

            /*BookInstantiate.Update start.*/
            Update: function () {
if ( TRACE ) { TRACE( "BookInstantiate#Update", this ); }


            },
            /*BookInstantiate.Update end.*/
...
if ( TRACE ) { TRACE( "DG.Tweening.DOTweenModuleUtils.Physics#CreateDOTweenPathTween", this ); }
    ...
    /*Drag3DWithEvents start.*/
    Bridge.define("Drag3DWithEvents", {
        ...
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "Drag3DWithEvents#init", this ); }

                this.isDragging = false;
            }
        },
        methods: {
            /*Drag3DWithEvents.Start start.*/
            Start: function () {
if ( TRACE ) { TRACE( "Drag3DWithEvents#Start", this ); }

                this.cam = UnityEngine.Camera.main;
            },
            /*Drag3DWithEvents.Start end.*/

            /*Drag3DWithEvents.OnPointerDown start.*/
            OnPointerDown: function (eventData) {
if ( TRACE ) { TRACE( "Drag3DWithEvents#OnPointerDown", this ); }
                ...
                if (UnityEngine.Physics.Raycast$1(ray, hit)) {
                    this.dragDistance = pc.Vec3.distance( this.cam.transform.position, hit.v.point );
                }
            },
            /*Drag3DWithEvents.OnPointerDown end.*/

            /*Drag3DWithEvents.OnDrag start.*/
            OnDrag: function (eventData) {
if ( TRACE ) { TRACE( "Drag3DWithEvents#OnDrag", this ); }
                ...
                var ray = this.cam.ScreenPointToRay(UnityEngine.Input.mousePosition);
                var targetPos = ray.GetPoint(this.dragDistance);
                this.transform.position = targetPos.$clone();
            },
            /*Drag3DWithEvents.OnDrag end.*/

            /*Drag3DWithEvents.OnPointerUp start.*/
            OnPointerUp: function (eventData) {
if ( TRACE ) { TRACE( "Drag3DWithEvents#OnPointerUp", this ); }

                this.isDragging = false;
            },
            /*Drag3DWithEvents.OnPointerUp end.*/


        }
    });
    /*Drag3DWithEvents end.*/
...
if ( TRACE ) { TRACE( "GameManager#Start", this ); }
                ...
                TaskManager.Instance.RunUntil(Bridge.fn.bind(this, function () {
                    return this.level === 1;
                }), Bridge.fn.bind(this, function () {
                    DG.Tweening.TweenSettingsExtensions.SetEase$2(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions), DG.Tweening.ShortcutExtensions.DOLocalMove(this.Tray.transform, new pc.Vec3( this.trayPos[((this.level - 1) | 0)], 0.0, 0.0 ), 1.0), DG.Tweening.Ease.InOutBack);
                }));
                TaskManager.Instance.RunUntil(Bridge.fn.bind(this, function () {
                    return this.level === 2;
                }), Bridge.fn.bind(this, function () {
...
if ( TRACE ) { TRACE( "GameManager#StartMusic", this ); }
    ...
    /*MoveTray start.*/
    Bridge.define("MoveTray", {
        inherits: [UnityEngine.MonoBehaviour],
        methods: {
            /*MoveTray.Start start.*/
            Start: function () {
if ( TRACE ) { TRACE( "MoveTray#Start", this ); }


            },
            /*MoveTray.Start end.*/

            /*MoveTray.Update start.*/
            Update: function () {
if ( TRACE ) { TRACE( "MoveTray#Update", this ); }
...
if ( TRACE ) { TRACE( "AudioManager#FadeOutAndStop", this ); }
    ...
    var $m = Bridge.setMetadata,
        $n = ["System","System.Collections.Generic","UnityEngine","System.Collections","UnityEngine.EventSystems","DG.Tweening","UnityEngine.Audio","DG.Tweening.Core","DG.Tweening.Plugins.Core.PathCore","UnityEngine.UI","System.Globalization","DG.Tweening.Plugins.Options"];
    ...
    /*MoveTray start.*/
    $m("MoveTray", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[0].Void},{"a":1,"n":"Update","t":8,"sn":"Update","rt":$n[0].Void}]}; }, $n);
    /*MoveTray end.*/
